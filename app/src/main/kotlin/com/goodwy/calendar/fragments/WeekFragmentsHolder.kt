...
import com.goodwy.calendar.adapters.MyWeekPagerAdapter
import com.goodwy.calendar.databinding.FragmentWeekHolderBinding
import com.goodwy.calendar.databinding.WeeklyViewHourTextviewBinding
import com.goodwy.calendar.extensions.*
import com.goodwy.calendar.helpers.Formatter
import com.goodwy.calendar.helpers.WEEKLY_VIEW
import com.goodwy.calendar.helpers.WEEK_START_DATE_TIME
...
class WeekFragmentsHolder : MyFragmentHolder(), WeekFragmentListener {
    ...
    private fun setupWeeklyActionbarTitle(timestamp: Long) {
        ...
        binding.weekViewWeekNumber.text = "${getString(com.goodwy.commons.R.string.week_number_short)} $weekNumber"
    }
    ...
    override fun printView() {
        val lightTextColor = resources.getColor(com.goodwy.commons.R.color.theme_light_text_color)
        binding.apply {
