...
import com.goodwy.calendar.adapters.MyYearPagerAdapter
import com.goodwy.calendar.databinding.FragmentYearsHolderBinding
import com.goodwy.calendar.helpers.Formatter
import com.goodwy.calendar.helpers.YEARLY_VIEW
import com.goodwy.calendar.helpers.YEAR_TO_OPEN
...
class YearFragmentsHolder : MyFragmentHolder(), NavigationListener {
    ...
    override fun showGoToDateDialog() {
        ...
        activity?.getAlertDialogBuilder()!!
            ...
            .setPositiveButton(com.goodwy.commons.R.string.ok) { _, _ -> datePicked(datePicker) }
            .apply {
